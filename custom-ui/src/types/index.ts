...
export interface AgentInfo {
  ...
  isDefault?: boolean; // Default agents can't be deleted, only edited to select model
  // User-created agent support
  isUserCreated?: boolean; // User-created agents stored in localStorage
}
...
// Export Entity type alias for convenience
export type Entity = AgentInfo | WorkflowInfo;
...
// Function call interface for display
